...
@Component
@Scope("prototype")
public class KarafLinkingSocketClient {
    private static final String SERVER_IP = PropertyManager.getProperty("linking.server.karaf.ip");
    private static final int SERVER_PORT = PropertyManager.getIntProperty("linking.server.karaf.port");
    private static final long SERVER_TIMEOUT = PropertyManager.getIntProperty("linking.server.karaf.timeout");
