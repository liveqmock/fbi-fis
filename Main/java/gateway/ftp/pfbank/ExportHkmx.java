 ...
 */
@Service
public class ExportHkmx implements EXPBankFile{
    ...
    //按指定格式组织结果集
    private String weaveResult(ArrayList list, int[] len) {
        String result = "";
    ...
    private String writePLHK(ArrayList messageList) {
    ...
    //往本地写文件并往银行FTP上传
    private boolean writeFile(String filename, String inputText)
            throws IOException {
    ...
    private void updatePaybackinfo() {
