...
public class CardInfoSendAction {
    ...
    public void init() {
        try {
            ...
            logger.error("查询"+strFinanceName+"未发送卡信息失败." + ex.getMessage());
    ...
    public String onBtnSendClick() {
        ...
        try {
            ...
            logger.error("发送"+strFinanceName+"卡信息失败:" + ex.getMessage());
        ...
        if (rtnmsg.equals(RtnTagKey.RESULT_SUCCESS)) {
            ...
            logger.error("发送"+strFinanceName+"卡信息返回失败信息:" + rtnmsg);
